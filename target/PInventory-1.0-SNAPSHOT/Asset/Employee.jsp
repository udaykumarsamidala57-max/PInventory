...
function enableEdit(id){
    ...
    document.getElementById(
    "edit_"+id).style.display="table-row";
}

function cancelEdit(id){

    document.getElementById(
    "text_"+id).style.display="table-row";
...
<form action="<%=request.getContextPath()%>/Staff"
method="post">
...
ResultSet rs =
(ResultSet)
request.getAttribute("locationData");
...
href="<%=request.getContextPath()%>/Staff?action=delete&id=<%=id%>">
