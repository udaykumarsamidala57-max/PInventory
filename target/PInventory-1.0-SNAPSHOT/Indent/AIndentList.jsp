    ...
    <div class="main-content">
        <div class="card">
            ...
            <table class="main-table">
                <thead>
                    <tr>
                        <th>ID</th><th>Indent No</th><th>Date</th><th>Item</th><th>Qty</th>
                        <th>Available Qty</th><th>UOM</th><th>Department</th><th>Requested By</th>
                        <th>Purpose</th><th>In-Charge Action</th><th>In-Charge Status</th>
                        <th>L1 Approved By</th><th>Status</th><th>Actions</th><th>View / Print</th>
                    </tr>
                </thead>
                <tbody>
                <%
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <% if(("Incharge".equalsIgnoreCase(role)||"Global".equalsIgnoreCase(role)) && !"Approved".equalsIgnoreCase(I_Status) && !"Approved".equalsIgnoreCase(status)) { %>
