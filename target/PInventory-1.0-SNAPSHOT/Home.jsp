...
<div class="container">
    ...
    <div class="dashboard-row">
        <div class="summary-card">
            <h3>💰 Costliest Item</h3>
            <h2><%= request.getAttribute("costliestItem") %></h2>
            <p>Category: <%= request.getAttribute("costliestCategory") %></p>
            <p>Price: ₹<%= request.getAttribute("maxPrice") %></p>
        </div>
        <div class="summary-card">
            <h3>📦 Highest Stock Item</h3>
            <h2><%= request.getAttribute("maxQtyItem") %></h2>
            <p>Category: <%= request.getAttribute("maxQtyCategory") %></p>
            <p>Qty: <%= request.getAttribute("maxQty") %></p>
        </div>
