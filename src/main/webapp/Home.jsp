...
<style>
    * { box-sizing: border-box; }
    ...
    /* Summary Cards */
    .summary { display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; margin-bottom: 40px; }

    .summary-card { 
        background: white; border-radius: 10px; padding: 20px; width: auto;
    ...
    /* Combined Table Card */
    .table-box { background: white; border-radius: 10px; box-shadow: 0 3px 10px rgba(0,0,0,0.08); padding: 15px; overflow-x: auto; }
    ...
    /* Stages Section */
    .stages { background: white; border-radius: 10px; box-shadow: 0 3px 10px rgba(0,0,0,0.08); padding: 20px; margin-top: 30px;
        display: inline-block; width: fit-content; max-width: 100%; margin-left: auto; margin-right: auto; text-align: center;
    }

    .stage-title { color: #003366; text-align: center; margin-bottom: 20px; font-weight: 600; font-size: 20px; }
    .stage-cards { display: flex; flex-wrap: wrap; justify-content: center; gap: 15px; }

    .stage-card {
        flex: 0 1 180px; border-radius: 10px; text-align: center; padding: 15px;
        box-shadow: 0 3px 6px rgba(0,0,0,0.1); transition: transform 0.2s ease, box-shadow 0.2s ease;
    }
    .stage-card:hover { transform: translateY(-5px); box-shadow: 0 6px 12px rgba(0,0,0,0.15); }
    .stage-card h4 { margin: 5px 0; font-size: 16px; color: #003366; }
    .stage-card h2 { font-size: 26px; margin: 0; font-weight: bold; color: #004085; }
    ...
    @media (max-width: 576px) {
        ...
        .stage-card { flex: 1 1 45%; font-size: 14px; }
        .stage-card h2 { font-size: 22px; }
    }
