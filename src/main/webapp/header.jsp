...
.sidebar{
 ...
 color:#fff;padding:20px;transition:.3s;z-index:1000
}
.sidebar h2{margin-bottom:25px;text-align:center}
...
header{
 ...
 border-bottom:1px solid #e5e7eb;z-index:999
}
.brand{
...
/* ===== MAIN ===== */
main{
 margin-left:250px;padding:100px 30px
}
</style>
</head>
...
<!-- ===== ADMISSIONS MODULE ===== -->
<% if ("ADMISSIONS".equalsIgnoreCase(MODULE)) { %>
...
<a href="ApproveAdmission.jsp"><i class="fas fa-check"></i> Approvals</a>
...
<% if ("Store".equalsIgnoreCase(DEPT) || "Global".equalsIgnoreCase(ROLE)) { %>
<div class="dropdown">
...
<% if ("Finance".equalsIgnoreCase(DEPT) || "Global".equalsIgnoreCase(ROLE)) { %>
<div class="dropdown">
<button class="dropdown-btn"><i class="fas fa-shopping-cart"></i> Purchase</button>
<div class="dropdown-content">
 <a href="IndentPO">Create PO</a>
 <a href="ListPO.jsp">PO Report</a>
 <a href="GRNServlet">GRN</a>
</div>
</div>
<% } %>
